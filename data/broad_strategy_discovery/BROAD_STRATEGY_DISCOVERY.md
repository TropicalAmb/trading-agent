...
| initial_balance_vwap_retest | NQ | ib80_rvol10_depth25 | 57 | 56.1% | 1.62 | +0.209R | 15 | 60.0% | 1.22 | +0.090R | FAIL |
| volatility_compression_breakout | CL | compress40 | 65 | 52.3% | 1.20 | +0.078R | 12 | 58.3% | 1.21 | +0.095R | FAIL |
| opening_range_retest_continuation | CL | or60_break05_depth35 | 40 | 45.0% | 0.99 | -0.002R | 14 | 57.1% | 1.47 | +0.182R | FAIL |
| vwap_band_reentry | CL | z2_re1_flat035 | 6 | 83.3% | 7.18 | +0.708R | 2 | 50.0% | 1.72 | +0.246R | FAIL |
| initial_balance_vwap_retest | CL | ib80_rvol10_depth25 | 60 | 40.0% | 0.69 | -0.164R | 20 | 50.0% | 1.04 | +0.017R | FAIL |
| value_area_80_rule_rotation | CL | two_closes_stop025 | 6 | 66.7% | 1.43 | +0.154R | 2 | 50.0% | 0.60 | -0.214R | FAIL |
...
| overnight_range_break_retest | CL | break05_depth35 | 31 | 41.9% | 0.91 | -0.044R | 7 | 42.9% | 0.61 | -0.182R | FAIL |
...
| opening_range_midpoint_continuation | CL | or60_impulse50_depth25 | 32 | 37.5% | 0.57 | -0.232R | 10 | 40.0% | 0.75 | -0.138R | FAIL |
| nq_15m_opening_range_retest | NQ | opposite_edge_stop | 73 | 49.3% | 0.72 | -0.089R | 15 | 40.0% | 0.54 | -0.189R | FAIL |
| volume_climax_rejection | NQ | vol20_range15_edge25 | 57 | 42.1% | 0.92 | -0.033R | 10 | 40.0% | 0.62 | -0.194R | FAIL |
| initial_balance_failed_break | NQ | pierce010_flat | 81 | 38.3% | 0.63 | -0.188R | 22 | 36.4% | 0.62 | -0.192R | FAIL |
| nq_premarket_ema_engulfing | NQ | sep020 | 124 | 45.2% | 0.81 | -0.080R | 34 | 35.3% | 0.66 | -0.157R | FAIL |
| session_extreme_two_bar_reversal | CL | vwap15_confirm25 | 78 | 42.3% | 0.75 | -0.127R | 20 | 35.0% | 0.52 | -0.285R | FAIL |
| two_test_range_breakout | NQ | look24_range40_rvol12 | 31 | 38.7% | 1.05 | +0.020R | 6 | 33.3% | 0.87 | -0.045R | FAIL |
...
| overnight_range_break_retest | NQ | break05_depth35 | 26 | 53.8% | 1.50 | +0.177R | 6 | 33.3% | 0.76 | -0.124R | FAIL |
| prior_day_level_failure | CL | pierce000_close40 | 14 | 42.9% | 0.83 | -0.068R | 3 | 33.3% | 0.61 | -0.278R | FAIL |
| opening_drive_pullback | CL | impulse050 | 51 | 37.2% | 0.69 | -0.158R | 15 | 33.3% | 0.38 | -0.403R | FAIL |
| weekly_value_area_failed_auction | CL | outside00_retest10 | 10 | 50.0% | 0.92 | -0.032R | 3 | 33.3% | 0.21 | -0.534R | FAIL |
| opening_range_retest_continuation | NQ | or30_break05_depth35 | 50 | 50.0% | 1.29 | +0.105R | 10 | 30.0% | 0.56 | -0.227R | FAIL |
...
| prior_day_level_failure | NQ | pierce010_close35 | 28 | 32.1% | 0.62 | -0.183R | 7 | 28.6% | 0.34 | -0.384R | FAIL |
...
| two_test_range_breakout | CL | look24_range40_rvol12 | 22 | 40.9% | 0.84 | -0.079R | 6 | 16.7% | 0.22 | -0.567R | FAIL |
| nq_post_settlement_alignment | NQ | drift10_gap20 | 9 | 55.6% | 1.47 | +0.161R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
...
| nq_15m_opening_range_retest | CL | opposite_edge_stop | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
| nq_opening_shock_reversal | NQ | shock60_confirm3 | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
| nq_opening_shock_reversal | CL | shock40_confirm4 | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
| nq_post_settlement_alignment | CL | drift05_gap10 | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
| nq_premarket_ema_engulfing | CL | sep010 | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
| ny_open_three_bar_continuation | CL | drive_pause_break | 0 | 0.0% | 0.00 | +0.000R | 0 | 0.0% | 0.00 | +0.000R | FAIL |
