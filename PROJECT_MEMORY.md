...
**Broad restart evidence (binding, 2026-08-14):** Reddit/primary-source restart now covers **13 coded families / 54 paid-window symbol×variant tests**; zero passed the requested 70%+profitability+sample+dual-source gate. A public NQ 2010–2025 one-minute file was audited, not trusted blindly: 6,231 rows in a bounded 2012 100× scale-error episode were quarantined; 4,968,467 clean rows remain; aligned RTH daily returns correlate 0.9667 with Yahoo. Provenance is still unverified, so this file is permanently research-only and never a paper provider. High-hit long-history finalists all failed: best adequately sampled holdout was VWAP reentry n138 WR52.2% PF1.338 E+0.124R; Reddit 70%-claimed daily IBS adapted with a hard NQ stop was n100 WR42.0% PF1.066 E+0.024R; 15m capitulation was n45 WR26.7%. A development-only shallow nonlinear regime router produced validation n94 WR50.0% PF1.393 E+0.130R and untouched holdout n107 WR31.8% PF0.55 E−0.245R. Paid-current 3/4 and Yahoo 1/1 router prints are rejected as tiny samples. **No research engine was promoted and paper remains `CONFIG_ENTRY_GATE:NO_VALIDATED_PAPER_STRATEGY`.** Trade-silence diagnosis must recognize generic `CONFIG_ENTRY_GATE` decisions and suppress stale risk/quality blockers plus auto-restart suggestions; restarting cannot create a validated strategy. Do not lower gates, alter 1R TP1, raise risk, or quote tiny-sample WR to claim success. Reproducible code/artifacts: `broad_strategy_discovery.py`, `long_history_strategy_validation.py`, `long_history_regime_selector.py`, and `notebooks/broad_strategy_discovery.ipynb`.
